                ...
                <div class="col-md-10">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-external-link-square"></i>VIEW SPECIAL PRICE
                        </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group connected-group">
                                        ...
                                        <select name="client_zone" required id="client_zone" class="form-control">
                                            <option value="">--</option>
                                            <?php
                                            $zoneQuery = "SELECT DISTINCT country_tag FROM corporate_client_special_rate WHERE corporate_client_email='$corporate_client_email'  AND status='1'";
                                            $zoneResult = $db->link->query($zoneQuery);
                                            while($zoneRow = $zoneResult->fetch_assoc()){
                                                ?>
                                                <option value="<?php echo $zoneRow["country_tag"]; ?>"><?php echo $db->getCountryName($zoneRow["country_tag"]); ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
