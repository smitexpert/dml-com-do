                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="sender_name" name="sender_name" value="<?=$agent_name ?>" required="">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="sender_company" name="sender_company" value="<?=$agent_company; ?>" required="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="email" class="form-control" id="sender_mail" name="sender_mail" value="<?=$agent_email?>" required="">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                ...
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="hidden" class="form-control" id="agent_sender_mail" name="agent_sender_mail" value="<?php echo $agent_email; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="textarea" class="form-control" id="recipient_city" name="recipient_city">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="">ZIP</label>
                                                                <input type="text" class="form-control" name="recipient_zip" id="recipient_zip">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row">
                                                       <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="control-label">
                                                                    Select Service <span class="symbol required"></span>
                                                                </label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="control-label">
                                                                    DML Track ID <span class="symbol required"></span>
                                                                </label>
                                                                <input onclick="get_tracking_id(event)" style="cursor: pointer;" type="text" class="form-control agent_tracking_id" name="trackID" id="trackID" value="" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="control-label">
                                                                    <?php echo $agent_company . "Track No."; ?><span class="symbol required"></span>
                                                                </label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input style="text-align: right;" type="hidden" class="form-control" name="shipping_charge_old" id="agent_shipping_charge_old">
