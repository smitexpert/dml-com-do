...
$sql = "SELECT DISTINCT agent_client_price.principal_id, principals_name.principal_name FROM principals_name INNER JOIN agent_client_price ON agent_client_price.principal_id = principals_name.id WHERE agent_client_price.agent_client_email='$agent_email' ORDER BY principals_name.id ASC
";
                                                ...
                                                $new_query = $db->link->query($sql);
                                                    if($new_query->num_rows > 0){
                                                        while($new_row = $new_query->fetch_assoc()){
                                                            ?>
                                                            <option value="<?php echo $new_row['principal_id']; ?>"><?php echo $new_row['principal_name']; ?></option>
                                                            <?php
                                                        }
                                                    }
                                                ?>
