                                            ...
                                            <div class="country_form">
                                               <input type="hidden" name="primcipal" value="0">
                                                <select name="agent_principal" id="agent_principal" class="form-control" data-show-subtext="true" data-live-search="true" required>
                                                    <option value="">--</option>
                                                    <?php 
                                                          $zoneSql = "SELECT * FROM agent_principal WHERE agent_email = '$agent_client_email'";   
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="country_form">
                                               <input type="hidden" name="country" value="0">
                                                <select name="client_country" id="client_country" class="form-control" data-show-subtext="true" data-live-search="true" required>
                                                    <option value="">--</option>
