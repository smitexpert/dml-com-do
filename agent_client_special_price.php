									   ...
									   <?php $i=0; if ($result->num_rows > 0) {
											...
											<tr>
												...
												<div class="">
													...
													<a href="set_agent_client_special_price.php?agent_id=<?php echo $row['id']; ?>" class="btn btn-xs btn-warning tooltips" data-placement="top" data-original-title="Remove">SET PRICE</a>
