...
$corporate_email = Session::get('corporate_email');
$corporate_id = Session::get('corporate_id');
$id = Session::get('client_table_id');
$corporate_name = Session::get('corporate_name');
...
<body>
                ...
                <ul class="nav navbar-right">
                    ...
                    <li class="dropdown current-user">
                        <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" data-close-others="true" href="#">
                            ...
                            <span class="username">
                                <?php echo Session::get("corporate_name")." (".$corporate_id.")"; ?>
                            </span>
   ...
   <br>
    ...
    if(Session::get('type') == "corporate"){
        include("corporate_sidebar.php"); 
    }else{
