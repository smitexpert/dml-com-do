					...
					<ul class="main-navigation-menu">
						...
						<li class="">
							<a href="dashboard.php"><i class="clip-home-3"></i>
								<span class="title"> Dashboard </span><span class=""></span>
							</a>
						</li>
						...
						<li class="active open">
							<a href="javascript:void(0)"><i class="clip-cog-2"></i>
								<span class="title selected"> Consignment Area</span><i class="icon-arrow"></i>
								<span class="selected"></span>
							</a>
							<ul class="sub-menu">
								<li>
									<a href="consignment_booking.php">
								...
								<li>
									<a href="consignment_tracking.php">
										<span class="title">Consignment Track</span>
									</a>
								</li>								

								<li>
									<a href="consignment_reported.php">
										<span class="title">Reported Consignemnt</span>
									</a>
								</li>
						...
						<li>
							<a href="javascript:void(0)"><i class="clip-cog-2"></i>
								<span class="title"> Corporate Client Settings </span><i class="icon-arrow"></i>
								<span class="selected"></span>
							</a>
							<ul class="sub-menu">
								<li>
								...
								<li>
									<a href="corpo_client_priceset.php">
										<span class="title">Corporate Client Price Settings</span>
									</a>
								</li>
							</ul>
						</li>
						...
						<li>
							<a href="javascript:void(0)"><i class="clip-cog-2"></i>
								<span class="title"> Price/Weight Settings </span><i class="icon-arrow"></i>
								<span class="selected"></span>
							</a>
							<ul class="sub-menu">
						...
						<li>
							...
							<ul class="sub-menu">
								<li>
									<a href="book_consignemt.php">
										<span class="title">Book New Consignment</span>
									</a>
								</li>
								<li>
						...
						<li>
							<a href="http://www.cliptheme.com/preview/frontend/clip-one/index.html" target="_blank"><i class="clip-cursor"></i>
