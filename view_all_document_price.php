            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <table class="table table-bordered colored">
                       <caption style="text-align:left; font-weight: bold; font-size: 18px">View Document Price</caption>
                        <tr>
                            <th>COUNTRY</th>
                            <th>PRINCIPAL<span style="color: #FFF">_</span>NAME</th>
                            <?php
                            ...
                            while($row_principal = $rl_principal->fetch_assoc()){
                                ...
                                if($based == 1){
                                    ...
                                    while($weight_row = $rlt_d->fetch_assoc()){
                                        ...
                                        $sl_price = "SELECT price FROM principal_price WHERE zone='$zone' AND principal_id='$p_id' AND goods_type='D' AND weight='$weight'";
                                    ...
                                    while($weight_row = $rlt_d->fetch_assoc()){
                                        ...
                                        $sl_price = "SELECT price FROM principal_price WHERE country='$country_tag' AND principal_id='$p_id' AND goods_type='D' AND weight='$weight'";
                                        $rl_price = $db->link->query($sl_price);
                                        $row_price = $rl_price->fetch_row();
                                        echo '<td>'.$row_price[0].'</td>';
                                    }
                    ...
                    /*$sql = "SELECT DISTINCT country_tag FROM principal_zone";
